...
def load_and_process_file():
    global chunks, db, qa, chat_history
    ...
    if file_path:
        ...
        with open(file_base_name + '.txt', 'w',encoding='utf-8') as f:
            f.write(doc.decode('utf-8'))

        with open(file_base_name + '.txt', 'r',encoding='utf-8') as f:
            text = f.read()
        ...
        chat_history = []
def select_file():
    global file_path, file_base_name
    ...
    if file_path:
        ...
        # Re-load and process the new file
...
file_select_button = tk.Button(root, text="Select PDF File", command=select_file)
